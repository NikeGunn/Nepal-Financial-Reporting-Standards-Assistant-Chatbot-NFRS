"""
URL configuration for NFRS_Assistant project.
...
urlpatterns = [
    ...
    path('api/v1/chat/', include('api.chat.urls')),
    path('api/v1/knowledge/', include('api.knowledge.urls')),
